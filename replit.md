...
- Added animated gradient to "Copula" and "Apply" in navigation bar on all pages
...
- Added animated gradient effect to blue text ("Copula" in navbar and hero title, "Copula Program", "Academic Professional", "This February", "Apply" in navbar)
...
- Increased container to 600px height to show more of the preview images (100px padding top/bottom)
- Center/active image displays crystal clear with NO blur (filter: none !important)
- Main image displays at 400px height, full opacity and normal scale
- Preview slides show with blur (8px), reduced opacity (40%), and scale (85%)
- Smooth vertical sliding transitions with proper centering (100px offset calculation)
...
- Alumni page uses same animated gradient styling for visual consistency
...
- Carousel indicators: Fixed dot aspect ratio with flex-shrink and inline-block to prevent vertical stretching
